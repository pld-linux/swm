...
Summary(pl):	Ma³y menad¿er okien dla X Window
Name:		swm
Version:	1.3.4
Release:	1
License:	GPL
...
%description
sWM is a very small and fast window manager for the X Window System. It
...
%description -l pl
sWM jest bardzo ma³ym i szybkim menad¿erem okien dla X Window.  Powinien
dzia³aæ pod dowoln± wersj± Linuksa, BSD, UNIX i innych kompatybilnych
systemów.  sWM zosta³ zaprojektowany by dzia³aæ efektywnie nawet na Linux-PDA
takich jak Compaq iPAQ.  Je¿eli u¿ywasz go na jakiej¶ egzotycznej platformie
proszê *proszê* przy¶lij mejla, to i Twój system zostanie tu wymieniony.
sWM by³ testowany na: Linux Mandrake 8.1, Linux Mandrake 8.0, RedHat 6.0,
Debian 2.0.
